...
public class MyRequestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requests.add(new Request("8", 21, "underwood hills", "dominos.com", 21, 31, 1.2, 1, "Narendra", 4.5, 1.8, 23));
        requests.add(new Request("10", 22, "bankhead", "pizzahut.com", 21, 31, 1.2, 1, "Ron", 4.7, 1.1, 32));
        requests.add(new Request("11", 23, "colonial homes", "waffles.com", 21, 31, 1.2, 1, "Rahman", 5, 0.2, 38));
        requests.add(new Request("12", 24, "midtown", "chickfila.com", 21, 31, 1.2, 1, "Rahman", 5, 0.2, 38));
        requests.add(new Request("13", 25, "downtown", "wendys.com", 21, 31, 1.2, 1, "Vasu", 3.2, 1.1, 32));
        requests.add(new Request("14", 26, "greenbriar", "subway.com", 21, 31, 1.2, 1, "Dinesh", 4.3, 0.8, 26));
        requests.add(new Request("15", 27, "lakewood", "tacobell.com", 21, 31, 1.2, 1, "Sud", 3.9, 1.5, 23));
        requests.add(new Request("16", 28, "paces", "dunkin.com", 21, 31, 1.2, 1, "Sus", 3.7, 1.6, 17));
